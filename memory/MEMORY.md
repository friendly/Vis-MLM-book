...
- [Duplicate Index Fix](index_duplicates_fix.md) — \texttt spacing root cause; source fix insufficient (verified 2026-07-11) — every PDF build still needs the --fix-index pass
