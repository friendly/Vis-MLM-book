...
<!-- #| fig-cap: "Scatterplot matrix of the `NeuroCog` data. Points are suppressed here, focusing on the data ellipses and regression lines. Colors for the groups: `r colorize("Schizophrenic", "red")` (red),  `r colorize("SchizoAffective", "green")` (green), `r colorize("Control", "blue")` (blue)." 
-->
...
#| out-width: "80%"
#| fig-cap: "Biplot of the NeuroCog data. ..."
ggbiplot(neuro.pca, 
