...
In this analysis, I ignore the `SocialCog` variable because aspects of social cognition provide other
analyses discussed below (@sec-social-cog).
...
In @fig-NC-scatmat, we can see that the regression lines have similar slopes and similar data ellipses
