...
$c = \sqrt{2 F_{2, n-2}^{0.68}}$ for 2D plots and $c = \sqrt{3 F_{3, n-3}^{0.68}}$ for 3D. the difference is
usually invisible in plots.
...
(@eq-he-eigen)
. The eigenvalues, $\lambda_i$, give the "size" of each $s$ 
