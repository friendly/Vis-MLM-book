...
minimizing the angle or distance between these vectors.
...
$$
such that the correlation $\rho = \textrm{corr}(\mathbf{u}_1, \mathbf{v}_1)$ is maximized.
...
in the correlations between (`Xcan1`, `Ycan1`), (`Xcan2`, `Ycan2`), ...

Plotting the canonical scores:
...
#| fig-height: 5
#| out-width: "100%"
#| fig-cap: "Plots of canonical scores..."
