...
The directions of these hypotheses in a given plot show _how_ the group means differ in terms of a given contrast.[^HE-contrast-geometry]
...
_variable_ space, that we can see in 2D for selected pairs 
