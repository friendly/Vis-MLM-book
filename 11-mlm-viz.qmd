...
Anderson's and should not be blamed.
...
#| echo: false
#| out-width: "80%"
#| fig-cap: "Diagram of an iris flower showing the measurements of petal and sepal. Each flower has three sepals and three petals. The sepals have brightly colored central sections. _Source_: @DeSilva2020"
knitr::include_graphics(here::here("images/iris-diagram.jpg"))
```

So we understand what the measurements represent, @fig-iris-diagram superposes labels on a typical iris flower.
...
#| fig-width: 10
#| fig-height: 10
#| fig-cap: "Scatterplot matrix of the `iris` dataset."
...
sepal and petal variables taken together?" 
$$
\H0 : \mathbf{\mu}_\textrm{setosa} = \mathbf{\mu}_\textrm{versicolor} = \mathbf{\mu}_\textrm{virginica}
$$


Because there are three species, the test involves 2 degrees of freedom,
...
Now fit the model. As expected, the differences among groups is highly significant. 
