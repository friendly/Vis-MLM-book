...
$$ {#eq-Ec}
where $c = \chi^2_2 (0.68)$ for 2D plots and $c = \chi^2_3 (0.68)$ for 3D plots of standard 68% coverage
...
An ellipsoid representing variation in the means of a factor (or any other term reflected in a general linear hypothesis test, @eq-hmat) in the $\mat{H}$ matrix is simply the data ellipse of the fitted values for that term. But there is a question of
the relative scaling of the $\mat{H}$ and $\mat{E}$ ellipsoids. 
