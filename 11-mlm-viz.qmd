...
are a bit more challenging when you allow _separate_ slopes for groups on all quantitative 
variables, because there get to be too many terms to usefully display. But these models are complicated!
