...
shown in @fig-diabetes1 and @fig-ReavenMiller-3d
that led to the discovery of two distinct types of development of Type 2 diabetes (@sec-discoveries).
This dataset is available as `heplots::Diabetes` and contains the following numeric variables:
...
shown in @fig-ReavenMiller-3d nearly captured all available information.
```{r}
#| label: diabetes-pca
...
Then, find the centroids of the component scores ...
```{r}
