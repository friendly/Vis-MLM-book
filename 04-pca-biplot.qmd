...
and avoid overfilling by _feature extraction_, which amounts to ...
This is just another name for principal components regression ...
...
Printing the first 10 shows that ...
...
is concentrated in the largest dimension, I've used a $\log_{10}()$ scale on the horizontal axis.
...
using ggplot. The result, in @fig-mona-pca is instructive about how much visual information is contained
