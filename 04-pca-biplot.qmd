...
::: {.content-visible when-format="pdf"}
The online edition of this book shows this more clearly in an [animated graphic](https://friendly.github.io/Vis-MLM-book/04-pca-biplot.html#fig-outlier-animation) rotating the points smoothly from data space to PCA space. It uses `heplots::interpPlot()` to interpolate linearly from the positions of the points
