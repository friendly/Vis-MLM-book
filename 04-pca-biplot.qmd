...
The component `contrib` gives these variance contributions as percents, where each row and column sums to 100.
...
variables in the same space, by what amounts to regressions of these new variables on the principal component dimensions. For this example, it happens that some suitable variables are available in the dataset `state.x77`.
