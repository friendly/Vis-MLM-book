...
It was his dream of a Sphere passing through Flatland @fig-flatland-spheres that first awakend him to 
a third dimension.
...
variation in the data can be captured in 1D, 2D, 3D, ... summaries and views.
...
Then, a simple visualization is a plot of the proportion of variance for each component (or cummulative proportion)
against the component number, usually called a **screeplot**.

```{r}
#| label: fig:crime-ggscreeplot
#| out-width: "100%"
#| fig-cap: "Screeplots for the PCA of the crime data"
p1 <- ggscreeplot(crime.pca) + theme_bw(base_size = 14)
p2 <- ggscreeplot(crime.pca, type = "cev") + theme_bw(base_size = 14)
