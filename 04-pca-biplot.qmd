...
@fig-mona-screeplot shows the screeplot. Because there are so many components and most of the information
is concentrated in the largest dimension, I've used a $\log_10()` scale on the horizontal axis.
