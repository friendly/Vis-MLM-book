...
which aims to provide a simple interface to biplots within the `ggplot2` framework. I also use some convenient utility functions from **factoextra**.
...
a contrast of bill length with bill depth and body mass, while dimension 4 involve a contrast between
