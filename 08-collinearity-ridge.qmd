...
$\boldsymbol{\beta}\trans \boldsymbol{\beta}$ be less than $k$.
...
#| out-width: "80%"
#| echo: false
#| fig-cap: "Geometric interpretation of rigdge regression, using ellipsoids of the $\\text{RSS}(k)$ function. The blue circles at the origin show the constraint that the sum of squares of coefficients, $\\boldsymbol{\\beta}\\trans \\boldsymbol{\\beta}$ be less than $k$."
