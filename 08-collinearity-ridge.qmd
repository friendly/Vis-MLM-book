...
#| out-width: "80%"
#| fig-cap: !expr paste("Variance inflation plot. VIF is plotted on a log scale. Colored bands show regions of", colorize("low", "green"), colorize("medium", "blue"), "and", colorize("high", "red"), "variance inflation.")
...
other best subset regression methods. --> Extensions of LASSO in ML where interpretation less important than prediction.
\ix{LASSO}
\ix{model selection}
