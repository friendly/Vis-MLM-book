...
knitr::include_graphics("figs/wordcloud4.png")
```
...
::: column-margin
![**Projection**: The cover image from Hofstadter's *Goedel, Bach and Escher* illustrates projection of 3D solids onto each 2D plane.](figs/Cover-image-GBE.png)
:::
