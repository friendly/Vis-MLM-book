...
and then (c) shifting that to centroid of the data. The unit sphere is defined as the contour of Euclidean distance 1 from the origin,
...
A variety of _robust_ methods described later (**sec ??**) work by down-weighting outliers,
