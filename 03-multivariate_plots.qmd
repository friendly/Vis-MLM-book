...
ggpairs(peng, columns=c(3:6, 7),
        ...
        progress = FALSE) +
  theme_penguins() + theme(strip.text.x = element_text(size = 2),
...
ggpairs(peng, columns=c(3:6, 1, 2, 7),
  ...
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) + theme(strip.text.x = element_text(size = 0.5), 
                                                   axis.text.x = element_text(angle = -90),
           strip.text.y = element_text(size = 0.25))
```
