...
Parallel coordinate plots are an attractive alternative, with which we can visualize an arbitrary number of variables to get a visual summary of a potentially high-dimensional dataset.
...
plots to show data, in his case, to show changes in the rank ordering of US states over
previous censuses from XXX to his present.
