...
<!-- Data Ellipses -->
<!--# UA: Is there a reason the Data Ellipses section was added as a different .qmd file? Let me know if you want me to insert the full code/text here instead. -->
...
$$
where $\mathbf{S}^{1/2}$ represents a rotation and scaling and $\oplus$ represents translation to a new centroid.
...
#### Example: Canadian occupational prestige {#sec-prestige .unnumbered}
