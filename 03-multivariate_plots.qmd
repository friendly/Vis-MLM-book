...
as the Cholesky factor of $\mathbf{S}$. Slightly abusing notation and taking the unit sphere $\mathcal{P}$
...
These are illustrated in @fig-ellipses-coverage with ellipses of 50%, 68% and 95% coverage for a the matrix $\mathbf{S}$
