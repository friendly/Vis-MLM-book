...
To relate this to the data, we can plot the data, as in @fig-peng-ggplot1, and label the points identified as noteworthy. 
...
@fig-peng-cqplot. We could call this long-billed penguin "Cyrano". 
