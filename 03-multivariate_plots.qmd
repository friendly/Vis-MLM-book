...
"pac-man" symbols, ellipses, colored vars or shaded rectangles, as shown in 
...
#| fig-height: 8
#| out-width: "100%"
#| fig-cap: "Corrplot of the `crime` data, showing each pair of variables with an ellipse and the rounded value of the correlation."
crime |>
  select(where(is.numeric)) |>
  cor() |>
  corrplot(diag = FALSE, 
...
<!-- **TODO**: Mention Insleberg [-@Inselberg:1985] & Wegman [-@Wegman:1990]; Andrews plots [-@Andrews:72], ... -->
...
as in the original idea, or categorical factors ...

Here, I use the **ggpcp** package [@R-ggpcp], best described in @VanderPlas2023. ...
