...
[^other-vars]: Other choices are possible: we could instead try to model the behavioral variables, `antisocial` and `hyperact`.
...
Non Follow Through (NFT), but here I focus on the relations between ...
