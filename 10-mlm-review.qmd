...
schools, one in a low SES neighborhood ($n=37$) and the other a high SES one ($n=32$). The data look like this:
...
Fit the MANCOVA model, assuming equal slopes for all predictors
