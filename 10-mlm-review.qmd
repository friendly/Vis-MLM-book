...
In linear models analysis of covariance (ANCOVA) is most often used in a situation that comprises
a multi-group or multi-factor design, but one where there are one or more continuous predictors,
$x_1, x_2, \dots$ of an outcome $y$ that need to be taken into account. ...

**TODO**: Rohwer data here
