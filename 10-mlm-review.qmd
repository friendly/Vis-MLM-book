...
responses for subject $j$ in group $i, i=1,\dots g; j = 1, \dots n_i$. Then, @eq-SSP comes from the
identity
...
Similarly for the other two contrasts within these each of these two subsets, but I don't print the
results
