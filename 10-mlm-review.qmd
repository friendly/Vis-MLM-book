...
* **Completeness**: No relevant predictors have been omitted from the model. For example in the coffee, stress example (@sec-sec-avplots, @sec-data-beta), omitting stress from the model biases the effect of coffee on heart disease.
