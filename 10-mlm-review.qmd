...
Instead, you would look at the "simple effects"-- how the treatment works at levels of the other factor separately.
...
**TODO**: Consider moving initial part of the Plastic film 2x2 example, @#exm-plastic here. 
...
The remaining twelve, `exciting` ... `ownPA` relate to tests of whether the `Attr` classification of the photo
