...
Yet the combination of these ideas remains elusive. The `r package("VGAM", cite=TRUE)` handles the bivariate cases
of logistic and probit regression, but not much more. 
... _mention special cases_ ... And graphical methods ???
...
its coefficient for reading as "a doubling of income" is associated with an increase of XXX in reading".
...
Anova(mod1)  # Type II, partial test
```
