...
$x_0, x_1, x_2, \dots, x_i, \dots x_q$, these are expressed as  $\mathbf{B} = ( \mathbf{b}_0^\mathsf{T} , \mathbf{b}_1^\mathsf{T} , \dots \mathbf{b}_j^\mathsf{T} \dots, \mathbf{b}_p )^\mathsf{T}$, or more explicitly
