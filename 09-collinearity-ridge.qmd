...
#| fig-height: 5
#| out-width: "90%"
#| fig.cap: "Centering a predictor removes the necessary correlation in a quadratic regression. Left: linear relatioship fitting $y$ to the uncentered $x$. Right: fitting to the centered $(x - \\bar{x}$."
r1 <- R[1, 2]
r2 <- R[1, 3]
