...
At the time the Farquhar brothers wrote this pithy aphorism, graphical methods for understanding data had advanced considerably, but most statisticians still relied on tables to communicate their results, prompting their complaint. Most data tables
...
Plots for diagnosing problems with multivariate models are discussed in @sec-model-diagnostics-MLM.
\ix{diagnostic plots}
