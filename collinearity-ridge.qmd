...
difference, $z_1 = x_1 + x_2$ and $z_2 = x_1 - x_2$. For example, in a data set on fitness, we may have
...
The data set `genridge::Acetylene` gives data from @MarquardtSnee1975 on the `yield` of a chemical
