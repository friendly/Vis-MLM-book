...
I chose to use [Quarto](https://quarto.org/) over [bookdown](https://bookdown.org/) because I thought it would be easier to produce both the printed PDF and online HTML versions from the same source (using conditional divs like `.content-visible when-format=`).
...
I could work with R for analysis and graphs, and with LaTeX for all of the formatting of the book.


## Quarto discussions

Quarto book: HELP WANTED
https://github.com/quarto-dev/quarto-cli/discussions/11087

referencing equations inside `\begin{align}` environment 
https://github.com/quarto-dev/quarto-cli/issues/2275#issuecomment-3349142154
...
- fix your terminal & PATH

I'm working on Windows 10, so the RStudio Terminal panel is just what their use of MINGW64 gave me. I needed to use various utility programs and scripts that simply were not there

Solution: `echo $PATH` tells me that `/c/Users/friendly/bin` is at the start of my PATH.  So, simply copy utilities there.
