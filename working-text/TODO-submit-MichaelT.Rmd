...
- Worth describing what an exact test is and why it matters
...
- The name of the section header is off
...
- If we're using short form, then perhaps `educ`, `antisoc` and `hyperact` should all be quoted in back-ticks to give that special font?
