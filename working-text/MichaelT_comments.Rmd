...
```{r, eval = FALSE}
pak::pak(c("uschiLaa/galahr", "fawda123/ggord", "klaR", "gmonette/p3d", "sjPlot", "url::https://cran.r-project.org/src/contrib/Archive/tourrGui/tourrGui_0.4.tar.gz", "url::https://cran.r-project.org/src/contrib/Archive/RGtk2/RGtk2_2.20.36.3.tar.gz", "url::https://cran.r-project.org/src/contrib/Archive/gWidgets/gWidgets_0.0-54.2.tar.gz"))
