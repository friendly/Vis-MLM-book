...
Section 10.3.1, I'm not sure I understand, but isn't the $C$ matrix shown here getting $\beta_1$ and $\beta_2$, and not $\beta_2$ and $\beta_3$? I'm not sure what the example $CB$ has to do with... testing whether $x_2$ and $x_3$ contribute?
