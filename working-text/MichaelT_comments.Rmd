...
- For consistency/parallels in writing, I think the text elaborating the different panels for Figure 10.2 should also explicitly refer to $SSP_H$ and $SSP_E$, as opposed to referring to the middle panel and the right panel. 

## Section 10.3.1

I'm not sure I understand, but isn't the $C$ matrix shown here getting $\beta_1$ and $\beta_2$, and not $\beta_2$ and $\beta_3$? I'm not sure what the example $CB$ has to do with... testing whether $x_2$ and $x_3$ contribute?
...
- Regarding Figure 10.3 -- perhaps the issues could be made blindingly clear to the reader by including 1D lineplots? Could have a 1D horizontal lineplot for math, then a 1D vertical lineplot for reading. 

- This chapter could easily be split into multiple chapters.
