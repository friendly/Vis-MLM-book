...
#| echo: false
#| out-width: "100%"
#| fig-cap: "Data space and $\\mathbf{\\beta}$ space representations of Coffee and Stress.
   Left: Standard (68%) data ellipse. Right: Joint 95% confidence ellipse (blue) for
   ($\\beta_{\\text{Coffee}}, \\beta_{\\text{Stress}}$), CI ellipse (red) with 95% univariate shadows"
