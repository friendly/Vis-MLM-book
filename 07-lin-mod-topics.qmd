...
$\widehat{\mathbf{\beta}}_{\text{OLS}} = (\hat{\beta}_0, \hat{\beta}_1)$ represents the least squares estimate. 
* Other points, representing different fitting methods can be shown in the same plot. For instance, $\widehat{\mathbf{\beta}}_{\text{WLS}}$ and $\widehat{\mathbf{\beta}}_{\text{ML}}$
...
>parameter estimates in $\beta$ space are more _precise_ (have less variance) in the directions where the data are more _widely dispersed_, having more information about the relationship.
