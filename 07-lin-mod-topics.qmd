...
to illustrate _added variable plots_ and explain the perplexing result that increased coffee
...
is the same as that in the (3,2) cell of @fig-coffee-scatmat for the relation `Stress ~ Coffee` but with data ellipses of 40% and 68% coverage.
