...
$x$, and raising it to successive powers, 1, 2, 3. $x^0 = 1$, the constant term or intercept.
```{r}
M <- outer(1:8, 0:3, `^`)
...
For a factor with $k$ levels you are free to make up any $k-1$ contrasts that correspond
to $k-1$ questions or tests of hypotheses about the factor level means.
