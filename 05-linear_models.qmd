...
You can work out questions like these using `terms()` for a `"formula"` object.
The labels of these terms can then be turned back into a formula using `as.formula()`:
```{r terms-formula}
