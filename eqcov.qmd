...
$$
\mathbf{\Sigma}_1 = \mathbf{\Sigma}_2 = \cdots = \mathbf{\Sigma}_g \period
$$
...
(a) direct visualization of the information in the $\mat{S}_i$ and $\mat{S}_p$ using _data ellipsoids_ to show size and shape as minimal schematic summaries;

(b) a simple dotplot of the components of Box's M test: the log determinants of the 
$\mat{S}_i$ together with that of the pooled $\mat{S}_p$. Extensions of these simple plots raise the question of whether measures of heterogeneity other than that captured in Box's test might also be useful; and,
