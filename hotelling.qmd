...
it is harder to show them all together. ...
...
the `Left`, `Right`, `Top` and `Bottom` edge margins.

Before considering hypothesis tests, let's look at some exploratory graphics. @fig-banknote-violin shows univariate violin plots of each of the measures.

```{r}
#| label: fig-banknote-violin
#| out-width: "100%"
#| fig-cap: "Violin plot of the banknote variables"
banknote |>
...
Two dimensions account for 70% of the total variance of all the banknotes.
```{r banknote-pca}
