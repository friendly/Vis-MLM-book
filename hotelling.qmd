...
banknotes can be distinguished. The measures are the `Length` and `Diagonal` lengths of a bill and
...
### Goodness-of-fit: Eta square ($\eta^2$)
...
for ANOVA-type models [@Pearson-1903] is the _differentiation ratio_ $\eta^2$, defined as 
$$
\eta^2 = \frac{\text{SS}_\text{Between groups}}{\text{SS}_\text{Total}}
$$
For multivariate response models, the generalization uses ...
