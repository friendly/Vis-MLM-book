...
analysis of variance, so to Hotelling's $T^2$ test provides an entry point to multivariate analysis of variance.
...
We can also see why the univariate test, at least for
