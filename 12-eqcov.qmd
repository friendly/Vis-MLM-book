...
Making boxplot of the absolute deviations in @fig-peng-devplots your eye can now focus on the average
...
$$
This is much stronger than in the univariate case, because it also requires that all the correlations between pairs of variables are the same for all groups. For example, in the case of two responses,
we must assume:
