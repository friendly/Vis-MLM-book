...
the properties shown in @tab-eigval-ellipse represent methods of describing the size and shape of the ellipsoid in $\Real{p}$.
More general theory and statistical applications of the geometry of ellispoids is given by
@Friendly-etal:ellipses:2013.

```{=latex}
#| label: tab-eigval-ellipse
\begin{table}[!htb]
...
in @tab-eigval-ellipse.  The results are shown in @fig-peng-boxm-plots.
