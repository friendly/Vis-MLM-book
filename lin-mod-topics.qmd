...
#| out-width: "100%"
#| fig-cap: "**The measurement error quartet**: Each plot shows the linear regression of _y_ on _x_, but where additional error variance has been added to _y_ or _x_ or both."
ggplot(df, aes(x, y)) +
