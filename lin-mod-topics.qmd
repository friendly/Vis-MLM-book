...
$$
\sizedmat{Y}{n \times p} = \sizedmat{X}{n \times q}  \sizedmat{B}{q \times p} \;+\; \sizedmat{U}{n \times p}
$$
...
regions for the data are given by the ellipsoids $(\bar{x}_1, \bar{x}_2)^\textsf{T} \oplus c \sqrt{\mathbf{S}}$.
...
@fig-coffee-data-beta shows this with data ellipses in data space and the corresponding
...
knitr::include_graphics("images/coffee-data-beta.png")
```
