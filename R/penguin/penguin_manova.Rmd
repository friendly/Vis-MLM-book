...
and the two culmen variables. One main virtue of the graphical methods used
...
To see this visually, consider a plot of the two `culmen` beak variables
...
in general species with larger culmen depth have smaller culmen length. 
...
only in the length of the culmen. Gentoo penguins differ from the other two
in having longer, but less deep culmen.
...
penguins have both larger and deeper culmens.
...
our penguin "size" variables. But culmen depth also separates Gentoo from the others, in the opposite direction 
