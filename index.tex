...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, sharp corners, enhanced, colback={codebgcolor}, breakable, boxrule=0pt]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
...
sugar level). They found a peculiar ``horse shoe'' pattern They found a
peculiar ``horse shoe'\,' shape in this relation (shown in
Figure~\ref{fig-diabetes1}), about which they could only speculate:
perhaps individuals with the best glucose tolerance also had the lowest
levels of insulin as a response to an oral dose of glucose; perhaps
those with low glucose response could secrete higher levels of insulin;
perhaps those who were low on both glucose and insulin responses
followed some other mechanism. In 2D plots, this was a mystery.
...
(\citeproc{ref-FoxWeisberg:2018}{2018a}) and Teetor
(\citeproc{ref-Teetor2011}{2011}) for learning about how to conduct
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, titlerule=0mm, toprule=.15mm, opacityback=0, leftrule=.75mm, opacitybacktitle=0.6, left=2mm, arc=.35mm, colframe=quarto-callout-note-color-frame, breakable, bottomtitle=1mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Datasaurus Dozen}, rightrule=.15mm, bottomrule=.15mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, titlerule=0mm, toprule=.15mm, opacityback=0, leftrule=.75mm, opacitybacktitle=0.6, left=2mm, arc=.35mm, colframe=quarto-callout-note-color-frame, breakable, bottomtitle=1mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Quartets}, rightrule=.15mm, bottomrule=.15mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white]
...
\textbackslash newcommand\{HO\}\{\mathcal{H}\_0\}
...
and Wood (\citeproc{ref-Wood:2006}{2006}) for generalized additive
...
Becker et al. (\citeproc{ref-Becker:1996:VDC}{1996});Cleveland
(\citeproc{ref-Cleveland:85}{1985}).
...
\(\sqrt{\mathbf{v}_1}, \sqrt{\mathbf{v}_1\), \dots\$ of the
...
(\citeproc{ref-PineoPorter2008}{Pineo \& Porter, 2008}) prestige score
for an occupational category, derived from a social survey) is related
...
\texttt{legend.position}) once, and then re-use these across several
graphs.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{legend.position }\OtherTok{\textless{}{-}}
...
(\citeproc{ref-R-corrplot}{Wei \& Simko, 2021}) packages, with different
...
\textbf{vcd} package (\citeproc{ref-R-vcd}{Meyer et al., 2023})
...
the \textbf{vcdExtra} (\citeproc{ref-R-vcdExtra}{Friendly, 2023})
...
\(||\mathbf{x}|| = (\mathbf{x}^\textsf{T} \mathbf{x})^{1/2} = \sqrt{\Sigma x_i^2}\),
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, titlerule=0mm, toprule=.15mm, opacityback=0, leftrule=.75mm, opacitybacktitle=0.6, left=2mm, arc=.35mm, colframe=quarto-callout-warning-color-frame, breakable, bottomtitle=1mm, toptitle=1mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{\texttt{rownames} in R}, rightrule=.15mm, bottomrule=.15mm, coltitle=black, colbacktitle=quarto-callout-warning-color!10!white]
...
\item
  ...
  correlation between those variables: the cosine of the angle between
  two variable vectors, \(\mathbf{v}_i\) and \(\mathbf{v}_j\) gives the
  approximation of the correlation between \(\mathbf{x}_i\) and
...
(\citeproc{ref-Gower-etal:2011}{2011}) provide a full treatment \ldots{}
...
\emph{Source}: Aluja et al. (\citeproc{ref-Aluja-etal-2018}{2018}),
Figure 2.11}
...
the supplementary variables and the scores on the principal components,
up to a scaling factor for each dimension. This provides a general way
to relate dimensions found in other methods to the original data
variables using vectors as in biplot techniques.
...
(\citeproc{ref-BorgGroenen2005}{2005}) give a comprehensive overview of
...
\texttt{MASS::isoMDS()}.\footnote{The \textbf{vegan} package
  (\citeproc{ref-R-vegan}{Oksanen et al., 2024}) provides
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-2.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-2}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-3.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-3}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-4.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-4}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-5.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-5}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-6.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-6}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-7.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-7}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-8.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-8}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-9.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-9}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-10.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-10}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-11.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-11}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-12.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-12}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-13.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-13}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-14.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-14}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-15.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-15}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-16.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-16}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-17.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-17}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-18.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-18}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-19.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-19}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-20.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-20}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-21.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-21}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-22.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-22}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-23.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-23}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-24.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-24}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-25.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-25}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-26.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-26}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-27.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-27}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-28.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-28}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-29.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-29}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-30.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-30}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-31.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-31}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-32.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-32}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-33.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-33}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-34.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-34}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-35.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-35}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-36.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-36}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-37.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-37}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-38.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-38}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-39.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-39}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-40.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-40}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-41.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-41}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-42.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-42}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-43.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-43}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-44.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-44}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-45.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-45}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-46.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-46}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-47.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-47}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-48.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-48}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-49.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-49}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-50.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-50}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-51.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-51}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-52.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-52}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-53.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-53}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-54.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-54}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-55.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-55}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-56.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-56}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-57.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-57}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-58.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-58}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-59.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-59}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-60.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-60}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-61.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-61}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-62.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-62}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-63.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-63}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-64.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-64}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-65.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-65}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-66.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-66}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-67.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-67}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-68.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-68}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-69.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-69}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-70.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-70}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-71.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-71}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-72.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-72}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-73.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-73}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-74.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-74}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-75.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-75}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-76.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-76}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-77.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-77}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-78.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-78}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-79.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-79}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-80.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-80}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-81.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-81}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-82.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-82}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-83.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-83}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-84.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-84}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-85.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-85}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-86.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-86}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-87.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-87}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-88.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-88}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-89.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-89}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-90.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-90}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-91.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-91}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-92.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-92}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-93.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-93}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-94.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-94}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-95.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-95}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-96.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-96}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-97.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-97}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-98.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-98}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-99.pdf}

}

\caption{\label{fig-diabetes-pca-tsne-anim-99}Animation of the
relationship of PCA to the t-SNE embedding for the Diabetes data.}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/ch04/fig-diabetes-pca-tsne-anim-100.pdf}
...
ones are as similar as possible.\footnote{The general topic of arranging
  ...
  (\citeproc{ref-R-seriation}{Hahsler et al., 2024}) provides a wide
...
\(\widehat{\mathbf{M}}_k = \mathbf{X}_k\;\mathbf{V}_k^\textsf{T}\) where
...
(\citeproc{ref-Galton:1886}{1886}, \citeproc{ref-Galton:1889}{1889})
...
Pearson (\citeproc{ref-Pearson:1896}{1896})
...
\includegraphics[width=0.4\textwidth,height=\textheight]{images/lin-comb2.png}
...
\subsubsection{Model matrices}\label{model-matrices}
...
\(H_0 : \mathbf{C} \mathbf{\beta} = 0\), using
...
(\citeproc{ref-R-modelsummary}{2024b})) is an easy to use, very general
...
(\citeproc{ref-R-marginaleffects}{Arel-Bundock, 2024a}) is similar and
...
favorite is the \textbf{effects} (\citeproc{ref-R-effects}{Fox et al.,
2022}) package, which alone provides partial residuals, and is somewhat
...
where
\(D^2 (\mathbf{x} - \bar{\mathbf{x}}) = (\mathbf{x} - \bar{\mathbf{x}})^\textsf{T} \mathbf{S}_X^{-1} (\mathbf{x} - \bar{\mathbf{x}})\).
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/fig-collin-data-beta-1.pdf}
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, titlerule=0mm, toprule=.15mm, opacityback=0, leftrule=.75mm, opacitybacktitle=0.6, left=2mm, arc=.35mm, colframe=quarto-callout-tip-color-frame, breakable, bottomtitle=1mm, toptitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Connection with inverse of correlation matrix}, rightrule=.15mm, bottomrule=.15mm, coltitle=black, colbacktitle=quarto-callout-tip-color!10!white]
...
\includegraphics[width=0.9\textwidth,height=\textheight]{figs/fig-cars-tableplot-1.pdf}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/fig-cars-collin-biplot-1.pdf}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/fig-collin-centering-1.pdf}
...
\item
  ...
  T^2 = N (\bar{\mathbf{x}}_1 - \bar{\mathbf{x}}_2)^\textsf{T} \; \mathbf{S}_p^{-1} \; (\bar{\mathbf{x}}_1 - \bar{\mathbf{x}}_2)
...
\includegraphics[width=0.7\textwidth,height=\textheight]{figs/fig-mathscore-cov1-1.pdf}
...
\includegraphics[width=0.7\textwidth,height=\textheight]{figs/fig-mathscore-cov2-1.pdf}
...
\includegraphics[width=0.7\textwidth,height=\textheight]{figs/fig-mathscore-HE-1.pdf}
...
\(\mathbf{p}_1 + \frac{\mathbf{d}^\textsf{T} (\mathbf{a} - \mathbf{p}_1)} {\mathbf{d}^\textsf{T} \mathbf{d}}\),
...
\includegraphics[width=0.7\textwidth,height=\textheight]{figs/fig-mathscore-HE-overlay-1.pdf}
...
\includegraphics[width=0.9\textwidth,height=\textheight]{figs/fig-mathscore-violins-1.pdf}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/fig-banknote-violin-1.pdf}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/fig-banknote-biplot-1.pdf}
...
\includegraphics[width=1.2\textwidth,height=\textheight]{figs/fig-NC-boxplot-1.pdf}
...
\includegraphics[width=0.9\textwidth,height=\textheight]{figs/fig-NC-corrgram-1.pdf}
...
\includegraphics[width=0.7\textwidth,height=\textheight]{figs/fig-NC-HEplot-1.pdf}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/fig-NC-HE-pairs-1.pdf}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/fig-NC-candisc-1.pdf}
...
\includegraphics[width=0.7\textwidth,height=\textheight]{figs/fig-SC-HEplot-1.pdf}
...
\includegraphics[width=0.7\textwidth,height=\textheight]{figs/fig-SC-cqplot-1.pdf}
...
\includegraphics[width=0.7\textwidth,height=\textheight]{figs/fig-SC1-hecan-1.pdf}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/fig-peng-covEllipse0-1.pdf}
...
{[}1{]} CRAN broom 1.0.6 2024-05-17 {[}1{]} CRAN candisc 0.9.0
2024-05-06 {[}1{]} CRAN car 3.1-2 2023-03-30 {[}1{]} CRAN carData 3.0-5
2022-01-06 {[}1{]} CRAN corpcor 1.6.10 2021-09-16 {[}1{]} CRAN
correlation 0.8.5 2024-06-16 {[}1{]} CRAN corrgram 1.14 2021-04-29
{[}1{]} CRAN corrplot 0.92 2021-11-18 {[}1{]} CRAN datawizard 0.12.2
2024-07-21 {[}1{]} CRAN dplyr * 1.1.4 2023-11-17 {[}1{]} CRAN easystats
...
ggbiplot 0.6.2 2024-01-08 {[}1{]} CRAN ggdensity 1.0.0 2023-02-09
{[}1{]} CRAN ggeffects 1.7.0 2024-06-20 {[}1{]} CRAN ggpcp 0.2.0
2022-11-28 {[}1{]} CRAN ggplot2 3.5.1 2024-04-23 {[}1{]} CRAN ggpubr
0.6.0 2023-02-10 {[}1{]} CRAN ggrepel 0.9.5 2024-01-10 {[}1{]} CRAN
ggstats 0.6.0 2024-04-05 {[}1{]} CRAN heplots 1.7.0 2024-05-02 {[}1{]}
CRAN Hotelling 1.0-8 2021-09-09 {[}1{]} CRAN imager 1.0.2 2024-05-13
{[}1{]} CRAN insight 0.20.2 2024-07-13 {[}1{]} CRAN knitr * 1.48
2024-07-07 {[}1{]} CRAN lubridate 1.9.3 2023-09-27 {[}1{]} CRAN magrittr
2.0.3 2022-03-30 {[}1{]} CRAN marginaleffects 0.21.0 2024-06-14 {[}1{]}
CRAN MASS 7.3-61 2024-06-13 {[}1{]} CRAN modelbased 0.8.8 2024-06-11
{[}1{]} CRAN modelsummary 2.1.1 2024-06-14 {[}1{]} CRAN parameters
0.22.1 2024-07-21 {[}1{]} CRAN patchwork 1.2.0 2024-01-08 {[}1{]} CRAN
performance 0.12.2 2024-07-18 {[}1{]} CRAN purrr 1.0.2 2023-08-10
{[}1{]} CRAN readr 2.1.5 2024-01-10 {[}1{]} CRAN report 0.5.9 2024-07-10
{[}1{]} CRAN Rtsne 0.17 2023-12-07 {[}1{]} CRAN see 0.8.5 2024-07-17
{[}1{]} CRAN stringr 1.5.1 2023-11-14 {[}1{]} CRAN tibble 3.2.1
2023-03-20 {[}1{]} CRAN tidyr 1.3.1 2024-01-24 {[}1{]} CRAN tidyverse
2.0.0 2023-02-22 {[}1{]} CRAN tourr 1.2.0 2024-04-20 {[}1{]} CRAN vcd
1.4-12 2023-12-29 {[}1{]} CRAN VisCollin 0.1.2 2023-09-05 {[}1{]} CRAN
