...
considering these questions: Why should you go to this trouble? What's in it for me?
...
#### Conceptual advantages {.unnumbered}
...
The idea of "self-concept", for instance, is comprised of all the beliefs that an individual has about him/herself.  These include physical, social, intellectual, family, emotional, and professional/academic domains, which reflect how individuals perceive their bodies, roles in society, abilities, as well as their familial connections, and competencies in work and school.[^factor-analysis] 

[^factor-analysis]: Factor analysis, of various flavors, is often used to study the relations of observed scales
for such constructs in terms of underlying, latent factors; however this is typically concerned with the _internal_
relations among variables, rather than how they are explained by outside predictors.
...
their correlations, which a multivariate approach can reveal.
...
#### Statistical advantages {.unnumbered}
...
* **Multivariable methods**  have a single dependent variable and more than one independent variable or covariate, such as in multiple regression. Multiple regression is the prime example.
...
A glimpse of this idea can be seen in @fig-cover-GEB, the cover image from Douglas Hofstadter's _Gödel, Escher, Bach_ [-@Hofstadter1979]. The complete image in 3D is made up of two 3D solids, with various complicated cutouts and holes.
...
<!-- ![**Projection**: The cover image from Douglas Hofstadter's _Gödel, Escher, Bach_ [-@Hofstadter1979] illustrates projection of 3D solids onto each 2D plane. Each 2D view captures some salient aspect of the complete figure.](images/Cover-GEB.png) -->

```{r}
#| label: fig-cover-GEB
#| echo: false
#| out-width: "60%"
#| fig-cap: "**Projection**: The cover image from Douglas Hofstadter's _Gödel, Escher, Bach_ [-@Hofstadter1979] illustrates projection of 3D solids onto each 2D plane. Each 2D view captures some salient aspect of the complete figure, but is incomplete."
