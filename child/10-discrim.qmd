...
with respect to the axes reflect the correlations of the _observed_ variables
...
#| fig-width: 6
#| out-width: "60%"
#| fig-cap: "Plot of the Penguin data in discriminant space, adding variable vectors to show the correlations of the observed variables with the discriminant dimensions."
p + gggda::geom_vector(
  data = vecs,
...
What is most apparent in @fig-peng-candisc is that the horizontal axis i