...
This example was intended to highly what is possible with dynamic graphics for exploring high-dimensional data visually. But it also illustrates limitations in implementation in **tourr**.
