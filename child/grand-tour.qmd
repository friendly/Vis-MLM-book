...
As you watch this pay attention to the separation of the species and any other interesting features.
...
What do you see? @fig-peng-tour-grand-frames shows three frames from this movie.
...
#| echo: false
#| out-width: "100%"
#| fig-cap: "Three frames from the grand tour of the Penguin data. (a) The initial frame is the projection showing only BD and BL, where bill length conveniently separates Adelie from the other two species. (b) A frame that shows the three species more widely separated. (c) A frame that shows two outliers."
#| fig-subcap: 
#|  - "Initial frame"
#|  - "Clusters"
#|  - "Outliers"
...
#| echo: false
#| out-width: "100%"
#| fig-cap: "**Guided tours**: These figures show the final frame in the animations of guided tours designed to find the projection that optimize an index."
#| fig-subcap: 
#|  - "optimizing `lda_pp()`"
...
@CookLaa-mulgar extend the discussion of these methods from @CookSwayne:2007 using Ggobi
to the **tourr** package and illustrate dimension reduction, various cluster analysis methods,
...
for later analysis; selecting or highlighting unusual points, changing tour methods or variables displayed
on the fly, and so forth.
Some packages that provide these capabilities are: 
[**detourr**](https://casperhart.github.io/detourr/index.html),
[**liminal**](https://sa-lee.github.io/liminal/),
and
[**langevitour**](https://logarithmic.net/langevitour/index.html).
