...
#| echo: false
#| out-width: "100%"
#| fig-cap: "**Veriable vectors**: Data variables viewed as vectors in the space of their projections. The angles of the **x** vectors with respect to the **y** coordinate axes show their relative contributions to each. The lengths of the **x** vectors show the relative degree to which they are represented in the space of **y**s. Left: the **P1** projection; right: the **P2** projection."
...
* Linear discriminant analysis (`lda_pp()`)
* PDA analysis (`pda_pp()`)
