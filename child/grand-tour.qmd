...
What did you see? @fig-peng-tour-grand-frames shows three frames from this movie. ...

::: {#fig-peng-tour-grand-frames layout-ncol=3}
![Initial frame](images/tours/peng-grand-tour1.png){#fig-peng-grand-tour1 width=150}

![Clusters](images/tours/peng-grand-tour2.png){#fig-peng-grand-tour2 width=150}
![Outliers](images/tours/peng-grand-tour3.png){#fig-peng-grand-tour3 width=150}
...
Let's take the penguins on a guide tour, trying to find views that show the greatest separations among the 
...
#| out-width: "75%"
#| echo: false
#| fig-cap: "Animation of a guided tour of the Penguin data, using a tour criterion designed to find an optimal separation among the penguin species."
