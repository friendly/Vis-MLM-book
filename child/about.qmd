...
― Brianna Wiest, _The Mountain Is You: Transforming Self-Sabotage Into Self-Mastery_ 
...
#### Email to John & Georges:
  
This has been far more challenging technically than anything I've done before, because I'm trying to use Quarto and produce both an HTML version (link above) and what will be the printed copy by CRC from my PDF. 
What I could do before for a printed version in LaTeX and .Rnw files is now much harder to do in .qmd, where I have to use YML configuration, latex partials, etc. The benefit is that I can do a simultaneous
HTML or epub version from the same source, can include animations or potentially interactive graphics, …

Amidst all this, I frequently had to go back to my packages and add/update functions to make my graphs better!  Or worse, contact other package authors to correct things or add features that would make the graphics better.
