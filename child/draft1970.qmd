...
#| out-width: "100%"
#| echo: false
#| fig-cap: "Congressman Alexander Pirnie (R-NY) drawing the first capsule for the Selective Service draft, Dec 1, 1969"
knitr::include_graphics("https://en.wikipedia.org/wiki/Draft_lottery_(1969)#/media/File:1969_draft_lottery_photo.jpg")
```
...
Fitting a line or smoothed (loess) curve ...
