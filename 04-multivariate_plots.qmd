...
-   `r func("pcp_select()")`: selections of the variables to be plotted and their
    horizontal order on parallel axes,
-   `r func("pcp_scale()")`: methods for scaling of the variables to each axis,
-   `r func("pcp_arrange()")`: methods for breaking ties in factor variables to
    space them out.
