...
* `r colorize("Adélie", "orange")`: `r colorize("orange", "orange")`, 
...
knitr::include_graphics("figs/ch04/fig-peng-ggpairs7-1.png")
```
...
#| out-width: "90%"
#| fig-cap: "Parallel coordinates plot of penguin size variables, together with sex and species."
knitr::include_graphics("figs/ch04/fig-peng-ggpcp1-1.png")
```
...
#| echo: false
#| fig-cap: "Parallel coordinates plot of penguin size variables, with the levels of species and island reordered."
knitr::include_graphics("figs/ch04/fig-peng-ggpcp2-1.png")
```
