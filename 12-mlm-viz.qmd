...
<!-- **TODO**: Check out signs of structure coefs from `cancor()`. Would be better to reflect the vectors for `Ycan1`. This needs to be fixed in `candisc::heplot.cancor()` by adding a `reflect =` argument. -->
