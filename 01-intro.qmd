...
* **Multi_variate_ methods** for linear models, such as multivariate multiple regression or multivariate analysis of variance,
...
[^psy6140]: The web pages for this course can be found at [http://friendly.apps01.yorku.ca/psy6140/]. I last taught this in 2016--2017.
...
Computationally, all of these are handled by a single R function, `lm()`. Methods for the resulting `"lm"` objects
...
thinking about substantive questions concerning differences among groups and testing these with
