...
**TODO:** Callout: Mention development in `lattice`, plot formulas, `y ~ x | g`. Describe faceting ...
...
The story is again different. Faculty in theoretical disciplines on average, earn about
10,000$ more per year on average. 
```{r discipline-means}
Salaries |>
  group_by(discipline) |>
...
variables we want to show separate effects for. In such cases, we can plot separate panels using the `ggplot2`
concept of _faceting_.
