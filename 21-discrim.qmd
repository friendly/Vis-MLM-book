...
It produces a `"ggplot"` object to which additional layers can be added, such as data ellipses and labels,
similar to what was done in @fig-peng-regions. You can use this as in the code below for a plot of
`body_mass ~ bill_length`, which gives
@fig-peng-plot-discrim. Here I simply added the data ellipses and text labels for the species
at their centroids.
