...
problems like principal components [@Pearson:1901] and multivariate distance [@Mahalanobis1936] in geometric terms, with matrix algebra as a muse to express these ideas and handmaid find solutions.
...
Data ellipses could then be added added using `r func("car::dataEllipse()")` as follows (this plot is not shown).
...
Plots showing decision regions such as @fig-peng-regions are made even easier using `r func("candisc::plot_discim()")`.
