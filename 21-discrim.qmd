...
Plotting the quadratic prediction regions in data space in the same manner as in @fig-peng-regions, gives ...
...
#| fig-width: 10
#| out-width: "100%"
#| fig-cap: "Plots of the Penguin data showing the quadratic discriminant prediction regions for the three species."
means <- peng |>
  group_by(species) |>
...
**TODO**: Complete the discussion here. Mention recursive partition methods as another topic, not covered here.
