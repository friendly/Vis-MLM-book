...
```{r include=FALSE}
source("R/common.R")
knitr::opts_chunk$set(fig.path = "figs/ch21/")
```
...
for the new observations. To make this easier, I created a general function `predict_discrim()`, which joins the measures in the
...
Using this you can simply plot the original Penguin data for two variables and use `geom_text()` or
