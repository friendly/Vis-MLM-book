...
You can see in @fig-peng-qda-regions that the decision boundaries for bill length and bill depth are only slightly curved.
The penguin species are widely separated in this view and the extra complexity of the quadratic
model doesn't make much difference in this view. In the right panel for flipper length and body mass,
