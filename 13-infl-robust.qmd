...
Earlier chapters (@sec-multnorm-penguin, @sec-dsq-penguin) presented a variety of plots (@fig-peng-cqplot, @fig-peng-ggplot-out, @fig-peng-out-biplot) for the Penguin data in which a few cases were identified as unusual in exploratory analysis.
...
The most influential case (283) here is our Chinstrap friend Cyrano (see @fig-peng-ggplot-out). Among the others, case 10 is
the Adelie bird we labeled Hook Nose.
