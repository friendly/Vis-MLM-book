...
- In first paragraph, a citation appears as "(Friendly & Sigal (2018))" instead of "(Friendly & Sigal, 2018)"
  ...
  + [FIXED 2026-07-11] Broader scan found similar `(@...)` patterns in Ch01, 03, 04, 05, 06, 07, 11 — full cleanup done on the `citation-fixes` branch per the reviewed inventory in `issues/solved/paren-citations.md` (25 build-file instances; 2 intentional/skip rows left as is).
