...
**"revolutionize"** (Ch06) is a clear example of a word to cut regardless of style register — it's a red-flag AI superlative.
...
4. **"elegant"** applied to statistical methods — Ch05, Ch07, Ch09. Usually cut without loss.

5. **`•` bullet markers** instead of `*` — Ch04. Structural mismatch with all other summaries.

---

## File-by-file specifics (worst first)

### Ch08-summary.qmd — most AI-flavored
...
- "magical tools", "journey from Flatland to Spaceland", "like adding helpful annotations to a map", "like organizing a messy bookshelf"
...
### Ch02, Ch05, Ch07 — minor issues only
- **Ch02:** "absolutely essential", "The overarching message is clear:", "Talk about the dinosaur in the room!" (exclamation)
- **Ch05:** "The beauty lies in...", "unlocks the full power of", missing comma after "However" (line 40)
- **Ch07:** "you can **literally** see and manipulate" — cut "literally"

---

## Clean model to follow

**Ch10-summary.qmd** is the cleanest file — plain factual bullets, no metaphors, no "you", no simile closer. Reads like scholarly prose. Other files should move toward that register, while preserving the author's own metaphors and enthusiasm.
