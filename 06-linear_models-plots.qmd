...
By definition, the residuals from this regression, $y \,\vert\, \text{others}$,
...
These residuals, $x_i \,\vert\, \text{others}$, give the part of $x_i$ that cannot be explained by the others, and so are uncorrelated with them.
