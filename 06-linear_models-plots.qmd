...
in a wide variety of formats, including HTML, PDF, LaTeX, Markdown, and MS Word.
```{r modelsummary1}
...
while income is measured id dollars.
...
Note that the coefficients in @fig-modelplot1 are ordered from bottom to top, because the Y axis starts
at the lower left corner. 
```{r}
#| label: fig-modelplot2
#| out-width: "80%"
#| fig-cap: "Plot of coefficients and their standard error bar for all three models"
modelplot(models, 
          coef_omit="Intercept", 
