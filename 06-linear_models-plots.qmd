...
#| eval: false
#| echo: false
# what are figure defaults?
knitr::opts_chunk$get(c("fig.width", "fig.height", "fig.align")) |> unlist()
```
...
The dashed blue line is the linear _partial fit_, $\hat{b}_i \mathbf{x}_i$,
