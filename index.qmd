...
It is assumed that the reader has a background in intermediate statistics including material on univariate linear models (ANOVA, multiple regression). The mathematical level will also be intermediate, in that formulas are used where necessary and matrix notation where it simplifies presentation. 
