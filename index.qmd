...
Then, R acquired the expressive language of the _Grammar of Graphics+_ [@Wilkinson:99] to compose plots
from: aesthetics, mapping data variables to visual features, geoms, ...
