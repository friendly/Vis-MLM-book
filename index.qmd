...
An accessible primer on how to create effective graphics from data using `r pkg("ggplot2")`.

* Antony Unwin [-@Unwin2024], _Getting (more out of) Graphics_,
Offers a collection of 25 case studies of interesting datasets, done using ggplot2 graphics
The R code for all chapters is [available online](https://github.com/antonr4/GmooGkodes).

* Nicola Rennie [-@Rennie2025], _The Art of Data Visualization with ggplot2_ ([online](https://nrennie.rbind.io/art-of-viz/)) offers a kind of master class in designing effective, attractive
graphics using `r pkg("ggplot2")`.
