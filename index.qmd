...
Similiarly, I use both base R graphics and plots based on the "ggverse" of `r pkg("ggplot2")`
and it's large family of add-on and extension packages.[^ggplot-ext] 
