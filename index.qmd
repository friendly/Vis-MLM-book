...
The book is organized into five parts that build progressively from orienting ideas and exploratory methods through increasingly sophisticated multivariate models:

```{tikz}
%| label: fig-book-parts
%| fig-cap: "The five parts of the book as a linear progression."
%| fig-align: center
%| out-width: 95%
%| echo: false
\smartdiagramset{
